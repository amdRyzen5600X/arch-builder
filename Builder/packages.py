...
BASE_PACKAGES = [
    "tumbler", "ffmpegthumbnailer", "lsd", "wezterm", "bat", "brightnessctl", "calc",
    "automake", "blueman", "bluez", "bluez-utils", "dunst", "fakeroot", "feh", "firefox",
    "zsh", "dpkg", "gcc", "gedit", "git", "gnu-netcat", "htop", "btop", "nano", "lxappearance",
...
DEV_PACKAGES = [
    ...
    "podman", "fzf", "filezilla", "ghex", "chromium", "keepassxc", "audacity",
    "gufw", "python-pywal", "bleachbit", "veracrypt", "homebank", "gtkhash",
    "gnome-firmware", "obs-studio", "telegram-desktop", "tmux", "youtube-dl",
    "neovim", "deluge-gtk", "flameshot", "sqlitebrowser", "python-pip",
    "bpython", "ipython", "cloc", "zoxide", "ripgrep", "nodejs", "npm",
]
